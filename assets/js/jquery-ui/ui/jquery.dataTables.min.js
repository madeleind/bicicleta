 ...
 */
/*Modificado sLengthMenu:"Mostrar _MENU_ Registros por pagina" linea 98*/
...
this.aanFeatures=[];this.oLanguage={sMarcarDesmarcar:"none",sProcessing:"Processing...",sLengthMenu:"",sZeroRecords:"No hay registros coincidentes",sInfo:"Mostrando _START_ al _END_ de _TOTAL_ Registros",sInfoEmpty:"Mostrando 0 al 0 de 0 registros",sInfoFiltered:"(filtrado de _MAX_  registros)",sInfoPostFix:"",sSearch:"Buscar:",sUrl:"",oPaginate:{sFirst:"Inicio",sPrevious:"<<",sNext:">>",sLast:"Final"}};
...
_fnMap(oSettings.oLanguage,oLanguage,"sLengthMenu");_fnMap(oSettings.oLanguage,oLanguage,"sZeroRecords");_fnMap(oSettings.oLanguage,oLanguage,"sMarcarDesmarcar");
...
if(oSettings.sTableId!==""&&typeof oSettings.aanFeatures.f=="undefined"){nFilter.setAttribute("id",oSettings.sTableId+"_filter")
    ...
    nFilter.innerHTML=oSettings.oLanguage.sSearch+sSpace+'<input id="campo_filtrar" name="campo_filtrar" type="text" />'+' <div style="display:'+oSettings.oLanguage.sMarcarDesmarcar+';"><input onClick="marcar(this.checked);" type="checkbox" /> Seleccionar Todo</div>';var jqFilter=$("input",nFilter);
