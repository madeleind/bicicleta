(function($){$.extend({progressBar:new function(){this.defaults={steps:20,step_duration:50,max:100,showText:true,textFormat:'percentage',width:121,height:12,callback:null,boxImage:'assets/js/jquery-ui/ui/progressBar/images/progressbar.gif',barImage:{0:'assets/js/jquery-ui/ui/progressBar/images/progressbg_red.gif',30:'assets/js/jquery-ui/ui/progressBar/images/progressbg_orange.gif',70:'assets/js/jquery-ui/ui/progressBar/images/progressbg_green.gif'},running_value:0,value:0,image:null};this.construct=function(arg1,arg2){var argvalue=null;var argconfig=null;if(arg1!=null){if(!isNaN(arg1)){argvalue=arg1;if(arg2!=null){argconfig=arg2;}}else{argconfig=arg1;}}
